...
const Tuakana = () => {
    ...
    const endpoint = `${baseUrl}/tuakanas?_embed`;
    ...
    const BoardPosts = ({ boardPosts }) => {
        const mappedBoardPosts = boardPosts.map((boardPost, index) => {
            ...
            return (
                <div key={boardPost.slug + "-" + index} id={postDirectionContainer} className="post-container">
    ...
    return (
        <>
            ...
            />
            <PageHeader title='Our Tuakanas' image_url="/headers-bg-image/about.jpg"/>
            <div id="pageContent">
